...
I plan to add more information at least about interesting Emacs build features (nativecomp, puregtk, &c.), as well as more system information.

Also, still need to figure out rational fallbacks or other values to check on things like custom-built desktops, because right now.....
