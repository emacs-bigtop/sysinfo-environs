...
#+begin_src tex
\usepackage[pdfusetitle,pdfcreator={TeX 3.141592653 (TeX Live 2025/Homebrew) using GNU Emacs 30.2 (build 1 [of 2025-11-14 17:02:42], GTK-toolkit (GTK 3.24.51) PureGTK build, no scroll bars, cairo version 1.18.4, with native compilation) with AUCTeX 14.1.0 on secureblue (powered by Fedora Atomic) (Linux 6.17.12-300.fc43.x8664 [\#1 SMP PREEMPTDYNAMIC Sat Dec 13 05:06:24 UTC 2025])}]{hyperref}
#+end_src
